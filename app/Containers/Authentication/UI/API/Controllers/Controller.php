...
class Controller extends ApiController
{
    ...
    public function logout(LogoutRequest $request)
    {
        ...
        $this->call('Authentication@ApiLogoutAction', [$dataTransporter]);
    ...
    public function proxyLoginForAdminWebClient(LoginRequest $request)
    {
        ...
        $result = $this->call(ProxyApiLoginAction::class, [$dataTransporter]);
    ...
    public function proxyRefreshForAdminWebClient(RefreshRequest $request)
    {
        ...
        $result = $this->call('Authentication@ProxyApiRefreshAction', [$dataTransporter]);
